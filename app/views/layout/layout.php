...
<body>
    ...
    <header class="bg-slate-900 border-b border-slate-800 sticky top-0 z-50">
        <nav class="container mx-auto px-6 py-4 flex items-center justify-between">
            <div class="flex items-center space-x-2">
                ...
                <span class="text-xl font-bold text-white tracking-tight">AI<span
                        class="text-indigo-400">Revenue</span></span>
            </div>
    ...
    <footer class="bg-slate-900 border-t border-slate-800 pt-16 pb-8">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <div class="col-span-1 md:col-span-1">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">
                        Libérez votre potentiel financier avec des plans d'action quotidiens générés par l'IA et des
                        opportunités de revenus sur mesure.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-slate-400 text-xs mb-4">Recevez une nouvelle opportunité de revenus chaque semaine.
                    </p>
                    <form class="flex">
                        <input type="email" placeholder="Votre email"
                            class="bg-slate-800 border-none rounded-l-lg px-4 py-2 text-sm text-white focus:ring-1 focus:ring-indigo-500 w-full">
                        <button
                            class="bg-indigo-600 px-4 py-2 rounded-r-lg text-white hover:bg-indigo-700 transition-colors">
            ...
            <div
                class="border-t border-slate-800 pt-8 flex flex-col md:row justify-between items-center text-slate-500 text-xs">
